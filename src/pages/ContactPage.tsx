...
export function ContactPage() {
  ...
  return (
    <div>
      {/* Hero: stretches nearly edge to edge like the Our story hero; its text lines up with the page content. */}
      <section className="px-3 sm:px-4 pt-3">
        <div className="relative rounded-[28px] overflow-hidden bg-secondary">
          ...
          <div className="relative max-w-7xl mx-auto px-5 sm:px-8 lg:px-10 py-14 sm:py-20">
            ...
            <p className="text-muted-foreground mt-5 max-w-lg text-[1rem]">Questions about an order, a scent, or a gift for a hundred guests. A real person in the studio replies within one business day.</p>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-3 gap-4 mt-12">
          {[
            ...
            <a key={title} href={href} {...(href.startsWith('http') && { target: '_blank', rel: 'noreferrer' })} className="group rounded-3xl bg-card p-7 flex flex-col gap-6 hover:shadow-[0_20px_40px_-24px_rgba(122,40,12,.35)]">
