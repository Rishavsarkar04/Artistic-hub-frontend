        ...
        <div className="mt-16 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 text-xs text-[#8F8577] border-t border-white/10 pt-6">
          ...
          <div className="flex flex-wrap items-center gap-6">
            ...
            <a
              ...
              className="group inline-flex items-center gap-1.5 h-8 pl-3.5 pr-3 rounded-full border border-[#F2C27B]/40 bg-[#F2C27B]/[.08] text-[#E9E2D6] transition-colors hover:bg-[#F2C27B] hover:border-[#F2C27B] hover:text-ink"
            >
              Developed by <span className="font-semibold text-[#F2C27B] group-hover:text-ink">Rishav Sarkar</span>
