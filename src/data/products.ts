...
export const testimonials = [
  {
    ...
    text: 'The Amber & Sandalwood is unlike anything I\'ve burned before. It fills the whole apartment without being overpowering — just a perfect warmth that lingers for hours after the flame goes out.',
    rating: 5,
  ...
  },
  {
    ...
    text: 'Ordered the gift trio for my partner\'s birthday and she immediately ordered three more for herself. The packaging alone is beautiful — these make the most thoughtful gift.',
    rating: 5,
  ...
  },
  {
    ...
    name: 'Priya Nair',
    location: 'Austin, TX',
    text: 'I\'ve been burned by "clean" candles before but the French Lavender is genuinely pure. No headache, no artificial edge. Just real lavender, exactly as promised.',
    rating: 5,
